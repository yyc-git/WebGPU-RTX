...
layout(binding = 3) uniform sampler2D gDiffusePositionWTexture;
...
layout(set = 1, binding = 6) uniform ScreenDimension { vec2 resolution; }
screenDimension;
...
void main() {
  ...
  vec3 diffuse = texture(gDiffusePositionWTexture, uv).xyz;
